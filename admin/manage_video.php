...
<div class="container mx-auto">
    <div class="mb-6">
        <a href="manage_modules.php" class="text-primary hover:underline">&larr; Back to All Modules</a>
    </div>
            ...
            <form id="video-form" enctype="multipart/form-data">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="file" name="video_file" id="video_file" accept="video/mp4" <?= !$data['video_id'] ? 'required' : '' ?> class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
                     ...
                     <div>
                        ...
                        <input type="file" name="thumbnail_file" id="thumbnail_file" accept="image/jpeg,image/png" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
