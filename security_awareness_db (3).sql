...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2025 at 05:50 PM
...
--
-- Table structure for table `monthly_posters`
--

CREATE TABLE `monthly_posters` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `description` text DEFAULT NULL,
  `assigned_month` date DEFAULT NULL,
...
--
-- Dumping data for table `monthly_posters`
--

INSERT INTO `monthly_posters` (`id`, `title`, `description`, `assigned_month`, `image_path`, `uploaded_by`, `posting_date`) VALUES
(1, 'test', 'tt', '2025-07-01', '6884b037868d4_Desktop background for July Finalize (2).png', 5, '2025-07-26 10:38:47');
...
--
-- Indexes for table `monthly_posters`
--
ALTER TABLE `monthly_posters`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `monthly_posters`
--
ALTER TABLE `monthly_posters`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Constraints for table `monthly_posters`
--
ALTER TABLE `monthly_posters`
  ADD CONSTRAINT `posters_ibfk_1` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
